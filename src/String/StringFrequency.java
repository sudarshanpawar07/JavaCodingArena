...
class StringFrequency {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nFirst Highest repeated Character : " + ch);

		char ch1 = firstLowestRepChar(str.toCharArray(), str.length());
		System.out.println("\nFirst Lowest repeated Character : " + ch1);

		char ch2 = secondHighestRepChar(str.toCharArray(), str.length());
		System.out.println("\nSecond Highest repeated Character : " + ch2);

		char ch3 = secondLowestRepChar(str.toCharArray(), str.length());
		System.out.println("\nSecond Lowest reapeated Character : " + ch3);
	}
	...
	public static void uniqueCharacter(char[] arr, int n) {
		...
		boolean[] t = new boolean[n];
		System.out.println("\nUnique Character of a String is : ");
